...
extension CalendarViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var presenter: ActivityRouter
        
        switch tableView {
        case eventsView:
            tableView.deselectRow(at: indexPath, animated: true)
            presenter = ActivityRouter(in: self, id: Constants.eventsControllerID, data: (events, date, user))
        case scheduleView:
            tableView.deselectRow(at: indexPath, animated: true)
            presenter = ActivityRouter(in: self, id: Constants.scheduleControllerID, data: (lessons, date, user))
        default:
            return
        }
    }
